...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $respuesta_secreta_encriptada = md5($respuesta_secreta);

    // Insertar los datos en la base de datos
    $sql = "INSERT INTO usuarios (nombre, Apaterno, Amaterno, Nombredeusuario, correo_electronico, contrasena, telefono, pSecreta, rSecreta) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
